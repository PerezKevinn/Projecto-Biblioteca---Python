...
class App():
    def __init__(self):
        ...
        self.TxtPass = ctk.CTkEntry(self.FrLogin, corner_radius=20, placeholder_text='CONTRASEÑA', placeholder_text_color='#FFFFFF', fg_color='#005066', border_width=0, width=230, textvariable=self.Pass, show='•')
        ...
        self.BtnShowHide = ctk.CTkButton(self.FrLogin, corner_radius=20, fg_color='#005066', text_color='#FFFFFF', text='Mostrar', hover=True, hover_color='#002029', command=self.toggle_password_visibility)
        ...
        self.BtnShowHide.place(relx=0.27, rely=0.65)
        self.BtnLogin.place(relx=0.27, rely=0.80)
    ...
    def toggle_password_visibility(self):
        if self.password_visible:
            ...
            self.BtnShowHide.configure(text='Mostrar')
        else:
            self.TxtPass.configure(show='')
            self.BtnShowHide.configure(text='Ocultar')
